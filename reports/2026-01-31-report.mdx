...
- feat(packages): add fcitx5-chewing and fcitx5-m17n by [@​tingweiwan](https://github.com/tingweiwan) in [#1689](https://github.com/ublue-os/aurora/pull/1689)
- fix: only remove /usr/share/doc/HTML by [@​renner0e](https://github.com/renner0e) in [#1688](https://github.com/ublue-os/aurora/pull/1688)
- chore: remove OpenCL-ICD-Loader workaround by [@​renner0e](https://github.com/renner0e) in [#1684](https://github.com/ublue-os/aurora/pull/1684)
- chore: move \{bazaar,fastfetch-\}user-count by [@​renner0e](https://github.com/renner0e) in [#1680](https://github.com/ublue-os/aurora/pull/1680)
...
**Automation Percentage:** 64.5% (318 bot PRs out of 493 total PRs)
...
- chore(deps): update quay.io/fedora-ostree-desktops/kinoite:43 docker digest to 99895aa by [@​ubot-7274](https://github.com/ubot-7274) in [ublue-os/aurora#1686](https://github.com/ublue-os/aurora/pull/1686)
- chore(deps): update quay.io/fedora-ostree-desktops/kinoite:43 docker digest to 770ac1b by [@​ubot-7274](https://github.com/ubot-7274) in [ublue-os/aurora#1683](https://github.com/ublue-os/aurora/pull/1683)
- chore(deps): update quay.io/fedora-ostree-desktops/kinoite:43 docker digest to 4ada765 by [@​ubot-7274](https://github.com/ubot-7274) in [ublue-os/aurora#1681](https://github.com/ublue-os/aurora/pull/1681)
